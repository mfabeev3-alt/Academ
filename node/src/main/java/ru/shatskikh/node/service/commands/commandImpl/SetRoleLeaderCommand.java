...
public class SetRoleLeaderCommand implements BotCommand {
    ...
    public void execute(Update update, AppUser admin) {
        ...
        var messageId = message.getMessageId();
            ...
            admin.setUserState(UserState.AWAITING_USER_FOR_ROLE);
    ...
    private void sendGroupList(Long chatId, Integer messageId) {
        ...
        messageSender.sendAnswerWithKeyboard("\uD83C\uDFDA Выберите группу, для которой вы хотите назначить старосту.",chatId, markup);
    }
